...
public class GlwssaParser extends Parser {
	...
	public static final int
		...
		RULE_statement = 8, RULE_assignment = 9, RULE_print_stmnt = 10, RULE_print_item = 11, 
		RULE_read_stmnt = 12, RULE_if_stmnt = 13, RULE_else_if_block = 14, RULE_else_block = 15, 
		RULE_select_stmnt = 16, RULE_case_block = 17, RULE_default_block = 18, 
		RULE_while_stmnt = 19, RULE_do_while_stmnt = 20, RULE_for_loop_stmnt = 21, 
		RULE_array_access = 22, RULE_procedure_call_statement = 23, RULE_expr = 24;
	private static String[] makeRuleNames() {
		return new String[] {
			"file", "program", "subprogram", "function", "procedure", "param_list", 
			"declarations", "var_decl", "statement", "assignment", "print_stmnt", 
	...
	public final Print_stmntContext print_stmnt() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_print_stmnt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Print_itemContext print_item() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_print_item);
		try {
			setState(164);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Read_stmntContext read_stmnt() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_read_stmnt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final If_stmntContext if_stmnt() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_if_stmnt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Else_if_blockContext else_if_block() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_else_if_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Select_stmntContext select_stmnt() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_select_stmnt);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final Case_blockContext case_block() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_case_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Default_blockContext default_block() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_default_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final While_stmntContext while_stmnt() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_while_stmnt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Do_while_stmntContext do_while_stmnt() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_do_while_stmnt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final For_loop_stmntContext for_loop_stmnt() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_for_loop_stmnt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Procedure_call_statementContext procedure_call_statement() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_procedure_call_statement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
